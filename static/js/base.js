(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-right', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-left', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-down', speed: 1000, intensity: 3, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-right', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-right', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-left', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 750, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('.gallery.style1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope ul > li', replay: false });
